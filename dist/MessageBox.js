...
exports.default = exports.SUGGESTED_EVALUATE = exports.DEFAULT_INTERPOLATE = exports.DEFAULT_ESCAPE = void 0;
...
var DEFAULT_INTERPOLATE = /{{{([^{}#][\s\S]+?)}}}/g;
// https://regex101.com/r/8sRC8b/8
exports.DEFAULT_INTERPOLATE = DEFAULT_INTERPOLATE;
var DEFAULT_ESCAPE = /{{([^{}#][\s\S]+?)}}/g;
// https://regex101.com/r/ndDqxg/4
exports.DEFAULT_ESCAPE = DEFAULT_ESCAPE;
var SUGGESTED_EVALUATE = /{{#([^{}].*?)}}/g;
exports.SUGGESTED_EVALUATE = SUGGESTED_EVALUATE;
var MessageBox = /*#__PURE__*/function () {
  ...
  _createClass(MessageBox, [{
    ...
    value: function getMessages(language) {
      ...
      if (messages) {
        if (globalMessages) messages = (0, _merge.default)({}, globalMessages, messages);
      } else {
    ...
    value: function message(errorInfo) {
      ...
      var fullContext = _objectSpread(_objectSpread({
      ...
      if (typeof message === 'string') {
        message = (0, _lodash.template)(message, {
          interpolate: this.interpolate,
          evaluate: this.evaluate,
          escape: this.escape
        });
    ...
    value: function messages(_messages) {
      (0, _merge.default)(this.messageList, _messages);
    }
  }, {
    key: "setLanguage",
    ...
    value: function defaults() {
      ...
      if (messages) {
        ...
        (0, _merge.default)(MessageBox.messages, messages);
      }
    }
  }]);
  return MessageBox;
